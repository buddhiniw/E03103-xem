...
c         write(*,*) ' ********'
c         write(*,*) ' Opening HMS matrix element file ',h_recon_coeff_filename
         write(*,'(a,a50)') ' HMS matrix element file: ',h_recon_coeff_filename
c         write(*,*) ' ********'
...
!         write(6,*) 'COEFF', (h_recon_coeff(i,h_num_recon_terms),i=1,4)
!         write(6,*) 'EXP', (h_recon_expon(i,h_num_recon_terms),i=1,4)
!         pause
!----------------------------------------------------------------------
      enddo
...
c      err = 'error opening file '//h_recon_coeff_filename
      goto 100

 94   istat = 4                         !Error reading or processing data.
      ABORT=.true.
c      err = 'error processing file '//h_recon_coeff_filename
      goto 100

 96   istat = 6                         !Too much data in file for arrays.
      ABORT=.true.
c      err = 'too much data in file '//h_recon_coeff_filename
      goto 100
